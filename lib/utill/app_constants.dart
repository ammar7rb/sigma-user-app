...
class AppConstants {
  ...
  static const String registrationPoliciesUri =
      '/api/v1/auth/registration-policies';
  ...
  static const String confirmOrderReceiptUri =
      '/api/v1/customer/order/confirm-receipt/';
  ...
  static const String quoteShippingForAddress =
      '/api/v1/shipping-method/quote-for-address';
  static const String selectShippingQuoteForAddress =
      '/api/v1/shipping-method/select-quote-for-address';
  ...
  static const String orderInsuranceQuote =
      '/api/v1/customer/order/insurance-quote';
  static String customerOrderInsuranceUri(int orderId) =>
      '/api/v1/customer/order-insurance/$orderId';
  static String customerOrderInsurancePayUri(int orderId) =>
      '/api/v1/customer/order-insurance/$orderId/pay';
  static String customerOrderInsuranceOfflineUri(int orderId) =>
      '/api/v1/customer/order-insurance/$orderId/offline';
  static String customerOrderInsuranceSupportUri(int orderId) =>
      '/api/v1/customer/order-insurance/$orderId/support';
  static String customerOrderInsuranceDeclineUri(int orderId) =>
      '/api/v1/customer/order-insurance/$orderId/decline';
  ...
  static const List<String> walletEarnTypeList = [
    ...
    'earned_by_referral',
    'due_payment_for_order',
    'return_order_amount_by_admin',
    'return_order_amount_by_seller'
  ];
