...
class _SupportConversationScreenState extends State<SupportConversationScreen> {
  ...
  void initState() {
    if(Provider.of<AuthController>(context, listen: false).isLoggedIn()) {
      ...
      _liveTimer = Timer.periodic(const Duration(seconds: 3), (_) => _refreshActivationConversation());
    }
    super.initState();
  }
  ...
  Future<void> _refreshActivationConversation() async {
    ...
    if (widget.supportTicketModel.purpose != 'account_activation' || _activationHandled || !mounted) return;
    ...
    final active = Provider.of<ProfileController>(context, listen: false)
        .userInfoModel?.activation?.isActive == true;
    if (active && mounted) {
      ...
      RouterHelper.getDashboardRoute(action: RouteAction.pushNamedAndRemoveUntil, page: 'home');
    }
  }
                      ...
                      child: TextField(
                        ...
                        style: textRegular.copyWith(fontSize: Dimensions.fontSizeDefault),
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: 'Type here...',
                            hintStyle: titilliumRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeDefault),
