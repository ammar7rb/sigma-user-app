      ...
      child: Scaffold(
        body: SafeArea(
          child: Center(child: CustomScrollView(slivers: [
            ...
            OnlySocialLoginWidget(fromPage: widget.fromPage, onLoginSuccess: widget.onLoginSuccess)  : SliverToBoxAdapter( // OnlySocialLoginWidget()
                child: Stack(
                  children: [
                        ...
                        child: Center(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: .06), blurRadius: 28, offset: const Offset(0, 12))],
                            ),
                                    ...
                                    child: Padding(
                                      ...
                                      child: Directionality(
                                        ...
                                        child: Image.asset(
                                          ...
                                          colorBlendMode: Theme.of(context).brightness == Brightness.dark ? BlendMode.srcIn : null,
                                        )
                                      ),
                                    ),
                                  ),
