      ...
      child: Consumer<ProductDetailsController>(
        builder: (context, details, child) {
          return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            if ((details.orderCount ?? 0) > 0 || (details.wishCount ?? 0) > 0)
              Padding(
                padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeSmall),
                child: Row(children: [
                  if ((details.orderCount ?? 0) > 0)
                    Text('${details.orderCount} ${getTranslated('orders', context)}',
                  ...
                  if ((details.wishCount ?? 0) > 0)
                    Text('${details.wishCount} ${getTranslated('wish_listed', context)}',
                        style: textRegular.copyWith(color: Theme.of(context).hintColor)),
                ]),
              ),
